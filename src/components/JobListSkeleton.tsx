        ...
        <div className='space-y-3'>
            ...
            <div className='flex items-center gap-2'>
                ...
                <div className='flex gap-1.5'>
                    {[1, 2, 3, 4].map((i) => (
                        <div key={i} className='h-[28px] w-16 bg-[var(--paper-3)] border border-[var(--line)] rounded-full animate-pulse' />
                    ))}
                </div>
            </div>
                ...
                {[1, 2, 3, 4, 5].map((i) => (
                    <div key={i} className='pr-4 pt-2.5 pb-2.5 space-y-2'>
                        <div className='flex items-start justify-between gap-3'>
                            ...
                            <div className='h-5 w-12 bg-[var(--paper-3)] border border-[var(--line)] rounded-full animate-pulse shrink-0' />
                        </div>
                        ...
                        <div className='flex items-center gap-2'>
                            <div className='h-7 w-20 bg-[var(--paper-3)] border border-[var(--line)] rounded-full animate-pulse' />
                            <div className='h-7 w-24 bg-[var(--paper-3)] border border-[var(--line)] rounded-full animate-pulse' />
                        </div>
                    </div>
                ))}
            </div>
